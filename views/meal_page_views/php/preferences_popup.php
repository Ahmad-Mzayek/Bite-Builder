<div id="preferences-popup" class="popup hidden flex-col w-[90%] items-center justify-between fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30 shadow-xl rounded-3xl py-6 bg-slate-100 overflow-hidden">
