<footer class="flex *:text-white flex-col w-screen items-center justify-between p-8 pr-12 bg-slate-600">
   ...
   <div class="flex items-center justify-around w-full pt-4">
      <div class="flex flex-col items-center justify-around w-full [&>*]:transition ml-4">
         ...
         <a class="hover:underline"
            target="_blank"
            href="https://www.linkedin.com/in/amir-bou-ghanem">
            Amir Bou Ghanem
         </a>
      </div>
      <div class="flex flex-col items-center justify-around w-full ml-4 border-l-2 border-r-2">
         ...
         <a class="hover:underline"
            target="_blank"
            href="https://www.github.com/amirbg2004">
            Amir Bou Ghanem
         </a>
      </div>
      <div class="flex flex-col items-center justify-around w-full">
         ...
         <a class="hover:underline"
            target="_blank"
            href="mailto:amirbg43@hotmail.com">
            Amir Bou Ghanem
         </a>
      </div>
   </div>
