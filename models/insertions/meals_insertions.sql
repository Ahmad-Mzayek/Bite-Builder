...
CALL insert_meal(
    ...
    "For the Caesar breadcrumbs: In a small nonstick skillet, melt butter over medium-low heat. Stir in anchovy paste and garlic and cook until fragrant, about 1 minute. Add breadcrumbs and, using a flexible spatula, toss to coat. Cook, stirring constantly until breadcrumbs are golden brown, about 3 minutes. Off heat, stir in the lemon zest and season with salt to taste. Transfer to a bowl and let cool completely.
    For cooking broccoli in the oven: Line a rimmed baking sheet with aluminum foil. Adjust oven rack to upper position and preheat oven to 500°F (260°C). Place baking sheet on oven rack to preheat.
    In a large bowl, toss broccoli florets with olive oil, salt, and pepper. Carefully add broccoli to preheated baking sheet in a single layer. Roast until broccoli is tender and deeply browned in spots, about 20 minutes (for the deepest browning on only one side, do not flip the broccoli during cooking; for more even browning all over, toss and flip broccoli about halfway through roasting).
    For cooking broccoli in the air fryer: Preheat a 6-quart air fryer to 400°F (205ºC) for 5 minutes. Meanwhile, in a large bowl, toss broccoli with oil, salt, and pepper to evenly coat. Working in batches if necessary, pour broccoli into the air fryer basket in an even layer and cook until broccoli is still bright green but starting to char around edges, about 5 minutes. Remove basket from air fryer and shake to toss broccoli florets. Return to air fryer and decrease temperature to 340°F (170ºC). Cook until broccoli is crisp-tender, about 3 more minutes. 
    For serving: In the now empty bowl, toss broccoli with lemon zest then transfer broccoli to a serving platter. Sprinkle with breadcrumbs and Parmigiano-Reggiano and serve.
...
CALL insert_meal(
    ...
    When ready to bake, remove cake pan from refrigerator, set on a rimmed baking sheet, and sprinkle remaining 1 tablespoon (15g) sugar evenly over surface of batter.
    Bake cheesecake, rotating pan 180 degrees halfway, until cheesecake jiggles as a whole, surface is deeply browned, and the outer edge feels slightly firm but the inner 4 1/2 to 5 inches still seems wobbly and underdone, 50 to 60 minutes. You can also check doneness with an instant-read thermometer: the cheesecake is done when the very center registers between 150 and 155ºF (65.5 to 68ºC) when an instant-read thermometer is inserted to a depth of 2 inches. For a more deeply browned top, see notes below.
    Let cheesecake cool in the pan on a wire rack at room temperature for 1 hour. Refrigerate uncovered for at least 4 hours before unmolding. To unmold the cheesecake, unlatch springform pan and remove pan sides. Holding by parchment overhang, carefully transfer cake to a cutting board or serving plate. Gently peel back parchment from sides of cheesecake, and use a sharp knife to cut into wedges. Serve chilled or allow the cheesecake to come  to room temperature before serving. Leftover cheesecake can be covered and refrigerated for up to 3 days.
    If you’d like more color on your cheesecake you can give it a brief stint under the broiler with your oven rack positioned about 7 inches from the top heating element. Be sure to keep a close eye on it as it can go from brown to burned very quickly.
...
CALL insert_meal(
    ...
    Place skewers on grate and cook over direct heat, turning once, until charred on both sides and a piece of beef looks cooked through when removed and cut in half, about 8 minutes. Transfer to serving platter and let rest 2 to 3 minutes (see note).
...
CALL insert_meal(
    ...
    "japanese_style_fried_chicken_thighs.png",
...
CALL insert_meal(
    ...
    Tip: Preheat your oven to 100 degrees F and turn off, then let the dough rise in the oven. Or use your oven's proof setting if you have it.
    ...
    Tip: While cooking, the bread will begin to puff up and fill with hot air, though results of each pita will vary. You can encourage a pocket to form by pressing lightly on the dough with a spatula or clean tea towel as it is cooking.
