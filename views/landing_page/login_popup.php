<div id="login-popup"
    ...
    <form id="login-form"
        ...
        <div class="relative w-full cursor-pointer">
            ...
            <svg class="show-password-icon show-password-icon-false hidden absolute inset-0 m-auto mr-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 640 512">
